...
(function(UI) {
    ...
    UI.modal.prompt = function(text, value, onsubmit, options) {
        ...
        var modal = UI.modal.dialog(([
            ...
            '<div class="uk-margin-small-top uk-modal-content uk-form"><p><textarea class="uk-width-1-1" rows='+(options.row || 5)+'></textarea></p></div>',
        ...
        input = modal.element.find("textarea").val(value || '').on('keyup', function(e){
            if (e.keyCode == 13) {
