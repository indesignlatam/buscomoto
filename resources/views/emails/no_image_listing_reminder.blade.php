...
@section('content')
	<h3 class="uk-text-bold">{{ trans('emails.no_image_listing_title') }}</h3>

	<div style="text-align:center; margin-top:20px">
		<h3><a href="{{ url('/admin/listings/'.$listing->id.'/edit') }}" class="uk-button uk-button-large uk-button-primary">{{ trans('emails.upload_images_listing') }}</a></h3>
	</div>

	<div style="margin-top:20px">
		<p>{{ trans('emails.no_image_listing_text') }}</p>
	</div>
