<!-- This is the modal -->
<div id="create_role_modal" class="uk-modal" data-focus-on="input:first">
    <div class="uk-modal-dialog">
        ...
        <form id="create_form" class="uk-form uk-form-horizontal" method="POST" action="/admin/roles">
			...
			<input class="uk-width-large-10-10 uk-margin-small-bottom uk-form-large" type="text" name="level" placeholder="Level" value="{{ old('level') }}">
		</form>
