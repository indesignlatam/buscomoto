...
<div id="upload_modal" class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <div class="uk-grid uk-grid-collapse">
        	<div class="uk-width-1-1">
        		<a class="uk-form-file uk-button uk-button-primary">{{ trans('admin.select_an_image_mobile') }}<input id="upload_select_modal" type="file" multiple></a>
		            	...
		            	if(response.image_path && response.success){
		            		...
		            		if(response.error instanceof Array){
		            			response.error.forEach(function(entry) {
		            				UIkit.notify('<i class="uk-icon-remove"></i> '+entry['image'], {pos:'top-right', status:'danger', timeout: 3000});
								});
		            		}else{
